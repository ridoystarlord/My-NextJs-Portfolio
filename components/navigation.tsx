        ...
        <div className="flex justify-between items-center h-20">
          ...
          <Link href="/">
            <motion.div
              ...
              whileTap={{ scale: 0.95 }}
              className="text-2xl font-bold bg-linear-to-r from-emerald-600 via-cyan-600 to-teal-600 bg-clip-text text-transparent"
            >
              Ridoy.dev
            </motion.div>
          </Link>
          ...
          <div className="hidden md:block">
            <Link href="/contact">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="px-6 py-2.5 bg-linear-to-r from-emerald-600 to-teal-600 text-white rounded-full font-medium shadow-lg hover:shadow-xl transition-all"
              >
                Let&apos;s Talk
              </motion.button>
            </Link>
        ...
        {isOpen && (
          ...
          >
            <div className="px-4 py-6 space-y-3">
              ...
              >
                <Link href="/contact">
                  <button className="w-full px-6 py-3 bg-linear-to-r from-emerald-600 to-teal-600 text-white rounded-lg font-medium shadow-lg">
                    Let&apos;s Talk
                  </button>
                </Link>
              </motion.div>
